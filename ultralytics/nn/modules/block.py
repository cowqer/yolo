...
from .conv import Conv, DWConv, GhostConv, LightConv, RepConv, autopad, RotateConv, AdaptiveRotatedConv2d
...
class RBottleneck(nn.Module):
    ...
    def __init__(self, c1, c2, shortcut=True, g=1, k=(3, 3), e=0.5):
        ...
        c_ = int(c2 * e)  # hidden channels
        self.cv1 = Conv(c1, c_, k[0], 1)
        self.cv2 = RotateConv(c_, c2, k[1], 1, g=g)
        self.add = shortcut and c1 == c2
...
class C2f_CoordAtt(nn.Module):
    ...
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5,reduction=32):
        ...
        self.cv2 = Conv((2 + n) * self.c, c2, 1)  # optional act=FReLU(c2)
        self.m = nn.ModuleList(Bottleneck(self.c, self.c, shortcut, g, k=((3, 3), (3, 3)), e=1.0) for _ in range(n))
        self.CoordAtt=CoordAtt(inp=c2, oup=c2, reduction=32)
